module ReferenceDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    connections DetumbleManager {
      ...
      detumbleManager.xPlusStart -> drv2605Face5Manager.start
      detumbleManager.xMinusStart -> drv2605Face2Manager.start
      detumbleManager.yPlusStart -> drv2605Face1Manager.start
      detumbleManager.yMinusStart -> drv2605Face0Manager.start

      detumbleManager.xPlusStop -> drv2605Face5Manager.stop
      detumbleManager.xMinusStop -> drv2605Face2Manager.stop
      detumbleManager.yPlusStop -> drv2605Face1Manager.stop
      detumbleManager.yMinusStop -> drv2605Face0Manager.stop
